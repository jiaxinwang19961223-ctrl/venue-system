...
export const createField = (data) => api.post('/venues/fields', data)
export const updateField = (id, data) => api.put(`/venues/fields/${id}`, data)
export const deleteField = (id) => api.delete(`/venues/fields/${id}`)
